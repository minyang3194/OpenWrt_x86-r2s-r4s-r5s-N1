...
sed -i "s/192.168.1/192.168.2/" package/feeds/kiddin9/base-files/files/bin/config_generate
sed -i "s/192.168.1/192.168.2/" package/base-files/files/bin/config_generate
